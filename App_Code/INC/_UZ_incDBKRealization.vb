...
Namespace SIS.INC
  Partial Public Class incDBKRealization
    ...
    Public ReadOnly Property DeleteWFVisible() As Boolean
      ...
      End Get
    End Property
    Public Shared Function DeleteWF(ByVal SerialNo As Int32) As SIS.INC.incDBKRealization
      Dim Results As SIS.INC.incDBKRealization = incDBKRealizationGetByID(SerialNo)
      Select Case Results.StatusID
        Case enumInvStates.Free, enumInvStates.Returned
          SIS.INC.incDBKRealization.incDBKRealizationDelete(Results)
      End Select
    ...
    Public ReadOnly Property InitiateWFVisible() As Boolean
      ...
      End Get
    End Property
    Public Shared Function InitiateWF(ByVal SerialNo As Int32, Optional FwdBatch As Integer = 0) As SIS.INC.incDBKRealization
      Dim Results As SIS.INC.incDBKRealization = incDBKRealizationGetByID(SerialNo)
      If FwdBatch = 0 Then FwdBatch = SIS.INC.incDBKRealization.GetNextFwdBatchNo()
      Select Case Results.StatusID
        Case enumInvStates.Free, enumInvStates.Returned
          With Results
            ...
            .Selected = False
          End With
          SIS.INC.incDBKRealization.UpdateData(Results)
      End Select
      Return Results
    End Function
    Public Shared Function InitiateAllFree(BatchNo As Integer, FWDBatchNo As Integer, RtnBatchNo As Integer) As Integer
      ...
      Return mRet
    End Function
    Public Shared Function GetByCommercialInvoiceNo(ByVal CInvNo As String) As SIS.INC.incDBKRealization
      Dim Results As SIS.INC.incDBKRealization = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "select top 1 * from INC_DBKRealization where CustomInvoiceNo='" & CInvNo & "'"
          Con.Open()
    ...
    Public Shared Function GetNextBatchNo() As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "select isnull(max(BatchNo),0)+1 as nb from INC_DBKRealization"
          Con.Open()
    ...
    Public Shared Function GetNextFwdBatchNo() As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "select isnull(max(FwdBatchNo),0)+1 as nb from INC_DBKRealization"
          Con.Open()
          mRet = Cmd.ExecuteScalar
        End Using
      End Using
    ...
    Public Shared Function GetNextRtnBatchNo() As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "select isnull(max(RtnBatchNo),0)+1 as nb from INC_DBKRealization"
          Con.Open()
          mRet = Cmd.ExecuteScalar
        End Using
      End Using
    ...
    Public Shared Function GetNextVchBatchNo() As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "select isnull(max(VchBatchNo),0)+1 as nb from INC_DBKRealization"
          Con.Open()
          mRet = Cmd.ExecuteScalar
        End Using
      End Using
    ...
    Public Shared Function UZ_incDBKRealizationSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal CustomInvoiceNo As String, ByVal BankID As Int32, ByVal StatusID As Int32, ByVal BatchNo As Int32, ByVal FwdBatchNo As Int32, ByVal RtnBatchNo As Int32) As List(Of SIS.INC.incDBKRealization)
      ...
      Return Results
    End Function
    Public Shared Function UZ_incDBKRealizationInsert(ByVal Record As SIS.INC.incDBKRealization) As SIS.INC.incDBKRealization
      Dim _Result As SIS.INC.incDBKRealization = incDBKRealizationInsert(Record)
      Return _Result
    End Function
    Public Shared Function UZ_incDBKRealizationUpdate(ByVal Record As SIS.INC.incDBKRealization) As SIS.INC.incDBKRealization
      Dim _Result As SIS.INC.incDBKRealization = incDBKRealizationUpdate(Record)
      Return _Result
    End Function
    Public Shared Function UZ_incDBKRealizationDelete(ByVal Record As SIS.INC.incDBKRealization) As Integer
      Dim _Result as Integer = incDBKRealizationDelete(Record)
      Return _Result
    End Function
    Public Shared Function SetDefaultValues(ByVal sender As System.Web.UI.WebControls.FormView, ByVal e As System.EventArgs) As System.Web.UI.WebControls.FormView
      With sender
        ...
        CType(.FindControl("F_ValueDate"), TextBox).Text = ""
        CType(.FindControl("F_Description"), TextBox).Text = ""
        CType(.FindControl("F_ScrollNo"), TextBox).Text = ""
        CType(.FindControl("F_ScrollDate"), TextBox).Text = ""
        CType(.FindControl("F_DBKAmount"), TextBox).Text = 0
