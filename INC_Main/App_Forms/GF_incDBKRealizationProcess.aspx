<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_incDBKRealizationProcess.aspx.vb" Inherits="GF_incDBKRealizationProcess" title="Maintain List: Process DBK Realization" %>
<asp:Content ID="CPHincDBKRealizationProcess" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelincDBKRealizationProcess" runat="server" Text="&nbsp;List: Process DBK Realization"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLincDBKRealizationProcess" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/INC_Main/App_Edit/EF_incDBKRealizationProcess.aspx"
      EnableAdd = "False"
      ValidationGroup = "incDBKRealizationProcess"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSincDBKRealizationProcess" runat="server" AssociatedUpdatePanelID="UPNLincDBKRealizationProcess" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVincDBKRealizationProcess" SkinID="gv_silver" runat="server" DataSourceID="ODSincDBKRealizationProcess" DataKeyNames="SerialNo">
      <Columns>
        ...
        <asp:TemplateField HeaderText="SB" SortExpression="[INC_DBKRealization].[FwdBatchNo]">
          <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="PB" SortExpression="[INC_DBKRealization].[VchBatchNo]">
          <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="DBK Realization Batch" SortExpression="[INC_DBKRealization].[DBK_BatchNo]">
          <ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_incDBKRealizationProcessSelectList"
      TypeName = "SIS.INC.incDBKRealizationProcess"
      SelectCountMethod = "incDBKRealizationProcessSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVincDBKRealizationProcess" EventName="PageIndexChanged" />
