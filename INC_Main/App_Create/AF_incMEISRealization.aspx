<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_incMEISRealization.aspx.vb" Inherits="AF_incMEISRealization" title="Add: MEIS Realization" %>
<asp:Content ID="CPHincMEISRealization" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelincMEISRealization" runat="server" Text="&nbsp;Add: MEIS Realization"></asp:Label>
</div>
...
<asp:FormView ID="FVincMEISRealization"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgincMEISRealization" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
...
<asp:ObjectDataSource 
  ...
  InsertMethod="UZ_incMEISRealizationInsert"
